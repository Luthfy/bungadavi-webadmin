...
<div class="content container-fluid">
    ...
    <!-- /Page Header -->
    @if ($data == null)
        {!! Form::open(['route' => 'bungadavi.corporateadmin.store', 'method' => 'POST','files' => true]) !!}
    @else
        {!! Form::model($data, ['route' => ['bungadavi.corporateadmin.update', ['corporateadmin' => $data->uuid]], 'method' => 'PUT','files' => true]) !!}
    @endif
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="h4">Corporate Admin Information</h4>
                </div>
                <div class="card-body">
                    <div class="row pb-4">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row">
                                <label class="col-form-label col-sm-12 col-md-12">Corporate Name <span class="text-danger">*</span></label>
                                <div class="col-sm-12 col-md-12">
                                    {!! Form::select('customer_uuid', [], null, ['class' => 'form-control', 'required' => true, 'id' => 'customer_uuid']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function (e) {
        getCorporateAdminAjax("{{ route('bungadavi.corporate.ajax.list') }}");
    });

    function getCorporateAdminAjax(url)
    {
        $.ajax({
                url: url,
                type: 'get',
