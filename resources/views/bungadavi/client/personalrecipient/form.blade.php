            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row pb-4">
                        <label class="col-form-label col-sm-12 col-md-2">Client Personal <span class="text-danger">*</span></label>
                        <div class="col-sm-12 col-md-10">
                            {!! Form::select('client_personal_uuid',$personal, null,['class' => 'form-control select2']) !!}
                        </div>
                    </div>
