...
<div class="content container-fluid">
    ...
    <!-- /Page Header -->
    @if ($data == null)
        {!! Form::open(['route' => 'bungadavi.corporate.store', 'method' => 'POST','files' => true]) !!}
    @else
        {!! Form::model($data, ['route' => ['bungadavi.corporate.update', ['corporate' => $data->uuid]], 'method' => 'PUT','files' => true]) !!}
    @endif
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="form-group">
                        <a href="{{ route('bungadavi.corporate.index') }}" class="btn btn-secondary">Back</a>
