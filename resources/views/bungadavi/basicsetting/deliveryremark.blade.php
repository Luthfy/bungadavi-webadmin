...
<div class="content container-fluid">
    ...
    <!-- /Page Header -->
    @if ($data == null)
        {!! Form::open(['route' => 'bungadavi.deliveryremark.store', 'method' => 'POST']) !!}
    @else
        {!! Form::model($data, ['route' => ['bungadavi.deliveryremark.update', ['deliveryremark' => $data->id]], 'method' => 'PUT']) !!}
    @endif
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="form-group">
                        <a href="{{ route('bungadavi.deliveryremark.index') }}" class="btn btn-secondary">Back</a>
