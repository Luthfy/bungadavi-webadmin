...
<div class="content container-fluid">
    ...
    <!-- /Page Header -->
    @if ($data == null)
        {!! Form::open(['route' => 'bungadavi.village.store', 'method' => 'POST']) !!}
    @else
        {!! Form::model($data, ['route' => ['bungadavi.village.update', ['village' => $data->id]], 'method' => 'PUT']) !!}
    @endif
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="form-group">
                        <a href="{{ route('bungadavi.village.index') }}" class="btn btn-secondary">Back</a>
