...
<div class="content container-fluid">
    ...
    <!-- /Page Header -->
    @if ($data == null)
        {!! Form::open(['route' => 'bungadavi.district.store', 'method' => 'POST']) !!}
    @else
        {!! Form::model($data, ['route' => ['bungadavi.district.update', ['district' => $data->id]], 'method' => 'PUT']) !!}
    @endif
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row pb-4">
                        <label class="col-form-label col-sm-12 col-md-2">JNE Code</label>
                        <div class="col-sm-12 col-md-10">
                            {!! Form::text('jne_code', null, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    <div class="form-group row pb-4">
                        <label class="col-form-label col-sm-12 col-md-2">SiCepat Code </label>
                        <div class="col-sm-12 col-md-10">
                            {!! Form::text('sicepat_code', null, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    <div class="form-group">
                        <a href="{{ route('bungadavi.district.index') }}" class="btn btn-secondary">Back</a>
