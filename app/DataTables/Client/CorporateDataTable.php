...
class CorporateDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($datatable) {
                $html  = "";
                $html .= "<a href='".route('bungadavi.corporate.edit', ['corporate' => $datatable->uuid])."' class='text-success m-1'><span class='fa fa-edit'></span></a>";
                $html .= "<a href='".route('bungadavi.corporate.show', ['corporate' => $datatable->uuid])."' class='text-primary m-1'><span class='fa fa-eye'></span></a>";
     ...
     *
     * @param \App\Models\Client/Corporate $model
    ...
    {
        return 'Client/Corporate_' . date('YmdHis');
    }
}
