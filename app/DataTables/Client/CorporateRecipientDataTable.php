...
class CorporateRecipientDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($datatable) {
                $html  = "";
                $html .= "<a href='".route('bungadavi.corporaterecipient.edit', ['corporaterecipient' => $datatable->uuid])."' class='text-success m-1'><span class='fa fa-edit'></span></a>";
                $html .= "<a href='".route('bungadavi.corporaterecipient.show', ['corporaterecipient' => $datatable->uuid])."' class='text-primary m-1'><span class='fa fa-eye'></span></a>";
    ...
    {
        return 'Client/CorporateRecipient_' . date('YmdHis');
    }
}
