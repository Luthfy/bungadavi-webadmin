...
class FloristRecipientDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($datatable) {
                $html  = "";
                $html .= "<a href='".route('bungadavi.floristrecipient.edit', ['floristrecipient' => $datatable->uuid])."' class='text-success m-1'><span class='fa fa-edit'></span></a>";
                $html .= "<a href='".route('bungadavi.floristrecipient.show', ['floristrecipient' => $datatable->uuid])."' class='text-primary m-1'><span class='fa fa-eye'></span></a>";
     ...
     *
     * @param \App\Models\Client/FloristRecipient $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(FloristRecipient $model)
    {
    ...
    {
        return 'Client/FloristRecipient_' . date('YmdHis');
    }
}
