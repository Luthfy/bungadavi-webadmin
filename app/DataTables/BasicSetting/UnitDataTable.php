...
class UnitDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($datatable) {
                $html  = "";
                $html .= "<a href='".route('bungadavi.unit.edit', ['unit' => $datatable->id])."' class='text-success m-1'><span class='fa fa-edit'></span></a>";
     ...
     *
     * @param \App\Models\BasicSetting/Unit $model
    ...
    {
        return 'BasicSetting/Unit_' . date('YmdHis');
    }
}
