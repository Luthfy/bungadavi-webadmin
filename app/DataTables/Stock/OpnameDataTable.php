    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($datatable) {
                $html  = "";
                $html .= "<a href='".route('opnames.edit', ['opname' => $datatable->uuid])."' class='text-success m-1'><span class='fa fa-edit'></span></a>";
                $html .= "<a href='".route('stocks.show', ['stock' => $datatable->stocks_uuid])."' class='text-primary m-1'><span class='fa fa-eye'></span></a>";
