    ...
    public function realTimeOrder()
    {
        ...
        $data = [
            ...
            'data'          => [
                ...
                'orderToday'    => $productToday->with('product')->with('materials')->with('materials.stock')->with('order.delivery_schedule')->orderBy('name_product', 'asc')->get()->toArray(),
                'orderTomorrow' => $productTomorrow->with('product')->with('materials')->with('materials.stock')->with('order.delivery_schedule')->orderBy('name_product', 'asc')->get()->toArray()
            ]
        ];
